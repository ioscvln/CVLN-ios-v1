---
title: ADR-0013 — Traceability is mandatory
purpose: Architecture decision record for D-013.
...
# ADR-0013 — Traceability is mandatory

## Context

The v1.1 baseline freeze requires that every binding rule of the CVLN Intelligence OS
exists as a decision record rather than as tribal convention. D-013 is one of the
fourteen foundational decisions listed in `decisions/DECISION-REGISTRY.md`.

## Decision

Every gap, decision and vulnerability links to at least one component or system node.
